...
val HomeIconComponent: ImageVector
    get() {
        if (_HomeIconComponent != null) {
            return _HomeIconComponent!!
        }
        _HomeIconComponent = ImageVector.Builder(
            name = "HomeIconComponent",
            defaultWidth = 50.dp,
            defaultHeight = 50.dp,
            viewportWidth = 576f,
            viewportHeight = 512f
...
private var _HomeIconComponent: ImageVector? = null
